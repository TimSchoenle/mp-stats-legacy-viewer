...
```bash
docker run --rm -p 8080:8080 timschoenle/mp-stats-legacy-viewer:v0.21.2
```
...
```bash
docker pull timschoenle/mp-stats-legacy-viewer:v0.21.2
```
...
pinned at `v0.13.0`. Neither binary takes command-line arguments.
...
docker run --rm -p 8080:8080 \
  ...
  timschoenle/mp-stats-legacy-viewer:v0.21.2
```

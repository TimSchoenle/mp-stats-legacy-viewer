...
```bash
docker run --rm -p 8080:8080 timschoenle/mp-stats-legacy-viewer:v0.21.3
```
...
```bash
docker pull timschoenle/mp-stats-legacy-viewer:v0.21.3
```
...
docker run --rm -p 8080:8080 \
  ...
  timschoenle/mp-stats-legacy-viewer:v0.21.3
```

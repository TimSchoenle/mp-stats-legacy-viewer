...
```bash
docker run --rm -p 8080:8080 timschoenle/mp-stats-legacy-viewer:v0.20.1
```
...
```bash
docker pull timschoenle/mp-stats-legacy-viewer:v0.20.1
```
...
docker run --rm -p 8080:8080 \
  ...
  timschoenle/mp-stats-legacy-viewer:v0.20.1
```
